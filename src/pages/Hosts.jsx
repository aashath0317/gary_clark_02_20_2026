                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="relative rounded-3xl overflow-hidden glass border border-glass-border shadow-2xl group animate-fade-in">
                            <div className="w-full bg-zinc-900 flex items-center justify-center overflow-hidden">
                                <img src="/gary_clark.webp" alt="Gary Clark - Super Bowl Champion & Host" className="w-full h-auto group-hover:scale-105 transition-transform duration-500" />
                            </div>
                        </div>
                ...
                <div className="container-custom">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2 relative rounded-3xl overflow-hidden glass border border-glass-border shadow-2xl group animate-fade-in fade-in-delay-1">
                            <div className="w-full bg-zinc-900 flex items-center justify-center overflow-hidden">
                                <img src="/chad.webp" alt="Chad Morton - Co-Host, Coach & Connector" className="w-full h-auto group-hover:scale-105 transition-transform duration-500" />
                            </div>
                        </div>
                    </div>
                </div>
