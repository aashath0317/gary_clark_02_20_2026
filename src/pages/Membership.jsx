            ...
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden border-b border-white/10">
                ...
                <div className="container-custom relative z-20 text-center">
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-8 animate-fade-in fade-in-delay-1 max-w-4xl mx-auto">
                        Join <span className="text-accent-primary">Legends Circle</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-text-secondary max-w-3xl mx-auto leading-relaxed animate-fade-in fade-in-delay-2">
                        Legends Circle is the inner circle of The NFLegend Experience—a community of fans, leaders, and game lovers who want deeper access, more connection, and more opportunities to be part of the story.
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding relative bg-bg-primary">
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 max-w-6xl mx-auto">
                        {/* Benefit 1 */}
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Play size={80} className="text-accent-primary transform rotate-12" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                        ...
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Shield size={80} className="text-accent-primary transform rotate-12" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                        ...
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Star size={80} className="text-accent-primary transform rotate-12 fill-current" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                        ...
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Users size={80} className="text-accent-primary transform rotate-12" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                                <Users size={24} />
                            </div>
                        ...
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Ticket size={80} className="text-accent-primary transform rotate-12" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                                <Ticket size={24} />
                            </div>
                            <h3 className="text-xl font-bold mb-3 relative z-10">Discounts on merch and events</h3>
                            <p className="text-text-secondary relative z-10">Exclusive pricing on ALL The NFLegend Experience gear and live show tickets.</p>
                        </div>

                        {/* Benefit 6 */}
                        <div className="glass p-8 rounded-2xl border border-accent-primary/20 hover:border-accent-primary/40 transition-colors group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <Gift size={80} className="text-accent-primary transform rotate-12" />
                            </div>
                            <div className="w-12 h-12 bg-accent-primary/10 rounded-xl flex items-center justify-center text-accent-primary mb-6 relative z-10">
                                <Gift size={24} />
                            </div>
                    ...
                    {/* Pricing / Join Box */}
                    <div className="max-w-xl mx-auto glass p-8 md:p-12 rounded-3xl border border-accent-primary/30 text-center relative overflow-hidden shadow-[0_0_50px_rgba(201,243,29,0.1)]">
                        ...
                        <ul className="text-left space-y-4 mb-10 text-white/90">
                            {[
                                ...
                                <li key={i} className="flex items-center">
                                    <div className="w-6 h-6 rounded-full bg-accent-primary/20 flex items-center justify-center mr-3 flex-shrink-0">
                                        <Check size={14} className="text-accent-primary font-bold" />
                                    </div>
                        ...
                        <button className="btn w-full bg-accent-primary text-black hover:bg-accent-primary-hover py-4 text-xl font-bold shadow-[0_0_20px_rgba(201,243,29,0.3)] hover:shadow-[0_0_30px_rgba(201,243,29,0.5)] transition-all">
